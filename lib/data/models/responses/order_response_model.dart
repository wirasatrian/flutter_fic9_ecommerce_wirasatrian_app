...
class AvailableBank {
  ...
  factory AvailableBank.fromMap(Map<String, dynamic> json) => AvailableBank(
        ...
        accountHolderName:
            accountHolderNameValues.map[json["account_holder_name"]]!,
  ...
  Map<String, dynamic> toMap() => {
        ...
        "account_holder_name":
            accountHolderNameValues.reverse[accountHolderName],
        "identity_amount": identityAmount,
      };
}

enum AccountHolderName { ABON_BALI }

final accountHolderNameValues =
    EnumValues({"ABON BALI": AccountHolderName.ABON_BALI});
