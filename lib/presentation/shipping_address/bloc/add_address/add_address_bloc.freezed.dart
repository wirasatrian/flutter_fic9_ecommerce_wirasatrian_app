  ...
  $Res call({
    ...
    return _then(_$AddAddressImpl(
      ...
      posCode: null == posCode
          ? _value.posCode
          : posCode // ignore: cast_nullable_to_non_nullable
              as String,
      userId: null == userId
          ? _value.userId
...
class _$AddAddressImpl implements _AddAddress {
  ...
  @override
  String toString() {
    return 'AddAddressEvent.addAddress(name: $name, address: $address, phone: $phone, provId: $provId, cityId: $cityId, subdistrictId: $subdistrictId, provinceName: $provinceName, cityName: $cityName, subdistrictName: $subdistrictName, posCode: $posCode, userId: $userId, isDefault: $isDefault)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.posCode, posCode) || other.posCode == posCode) &&
  ...
  TResult when<TResult extends Object?>({
    ...
    return addAddress(name, address, phone, provId, cityId, subdistrictId,
        provinceName, cityName, subdistrictName, posCode, userId, isDefault);
  }
